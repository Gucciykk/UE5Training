...
#define UE_PROJECT_NAME UE5_QuickStart
#define UE_TARGET_NAME UE5_QuickStartEditor
#define UE_MODULE_NAME "UE5_QuickStart"
...
#define UE5_QUICKSTART_API DLLEXPORT
